                    ...
                    $.each(value.comment,function(k,index){
                        if(!index.hide_setting){
                            ...
                            if($('button[name="'+ new1 +'"]').prop('disabled')==true){
                                re += "<br><button id='high' name='"+ index.com_num +"1' value='"+ index.com_num +"' class='btn btn-primary' disabled='disabled'>"+ index.high_rating + " <i class='fas fa-thumbs-up'></i> </button>";
                            }else{
                                re += "<br><button id='high' name='"+ index.com_num +"1' value='"+ index.com_num +"' class='btn btn-primary'>"+ index.high_rating + " <i class='fas fa-thumbs-up'></i> </button>";
                            }
                            var new2 = ''+index.com_num+'2'
                            if($('button[name="'+ new2 +'"]').prop('disabled')==true){
                                re += "<button id='low' name='"+ index.com_num +"2' value='"+ index.com_num +"' class='btn btn-primary' disabled='disabled'>"+ index.low_rating + " <i class='fas fa-thumbs-down'></i> </button>";
                            }else{
                                re += "<button id='low' name='"+ index.com_num +"2' value='"+ index.com_num +"' class='btn btn-primary'>"+ index.low_rating + " <i class='fas fa-thumbs-down'></i> </button>";
                            }
